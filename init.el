...
(custom-set-variables
 ...
 '(package-selected-packages
   '(company-prescient ivy-prescient prescient company-bibtex company-math math-symbol-lists company-reftex company-auctex mozc general all-the-icons-ivy-rich kind-icon cape gcmh corfu lsp-ivy lsp-treemacs lsp-ui lsp-mode dashboard projectile page-break-lines smartparens aas yasnippet doom-themes counsel ivy-rich rainbow-delimiters which-key all-the-icons cdlatex preview-dvisvgm preview use-package ivy doom-modeline command-log-mode auctex))
